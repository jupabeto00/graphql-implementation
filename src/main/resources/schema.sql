...
create table products (created_date timestamp(6) not null, id bigint generated by default as identity, number varchar(10) not null, type varchar(255) not null, primary key (id));
